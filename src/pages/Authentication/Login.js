...
import logoLight from "../../assets/images/sswnew.png";
...
const Login = (props) => {
    ...
    document.title = "S. S. White | Open-Source Ticket Request System";
    return (
        <React.Fragment>
            <ParticlesAuth>
                        ...
                        <Row>
                            <Col lg={12}>
                                <div className="text-center mt-sm-5 mb-4 text-white-50">
                                    ...
                                    <p className="mt-3 fs-1 text-white fw-medium">S. S. WHITE TECHNOLOGIES PVT. LTD</p>
                                </div>
                            </Col>
                        </Row>
                                ...
                                <Card className="mt-4 card-bg-fill">
                                    <CardBody className="p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted">Sign in to continue to OTRS.</p>
                                        </div>
